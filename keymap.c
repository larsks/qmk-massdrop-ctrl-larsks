...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNC] = LAYOUT(
        DBG_TOG, DBG_MTRX, DBG_KBD, DBG_MOU, _______, _______, _______, _______, _______, _______, _______, _______, _______,            KC_MUTE, _______, _______, \
    ...
    [_MOUSE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_MS_ACCEL0, KC_MS_ACCEL1, KC_MS_ACCEL2, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_MS_BTN1, KC_MS_BTN2, KC_MS_BTN3, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        MO(_WHEEL), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                              KC_MS_UP, \
...
void raw_hid_receive(uint8_t *data, uint8_t length) {
    dprintf("raw_hid_receive bytes:%d first:%0X\r\n", length, *data);
    raw_hid_buffer[0] = CTRL_HID_OK;
    raw_hid_buffer[1] = CTRL_HID_EOM;
